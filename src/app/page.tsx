    ...
    <div>
      <section className="hero">
        <div className="container">
          <h1 className="hero-title">Inspire Learning AI</h1>
          <p className="hero-subtitle">
            AI-powered educational platforms and content generation.
          </p>
          <div className="hero-actions">
            <Link href="https://github.com/inspirelearningai" className="btn btn-primary">
              View on GitHub
            </Link>
          </div>
        </div>
          ...
          <div className="grid">
            <div className="card">
              ...
              <p className="card-desc">
                Foundational tools and libraries that power the inspirelearningai ecosystem.
              </p>
            </div>
            <div className="card">
