          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <AnimatedSection className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-8 text-gray-900 leading-tight">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-rose-500 to-orange-300 animate-gradient-shift">
                  {t.hero.title}
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <motion.a href="https://github.com/inspirelearningai" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                  <Button variant="contained" size="large" endIcon={<ArrowRight />} sx={{ px: 4, py: 2, fontSize: "1.1rem", boxShadow: "0 8px 32px #F43F5E40" }}>
                    {t.hero.cta_github}
                  </Button>
                </motion.a>
      ...
      <section className="py-24 bg-gray-50/50">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl font-bold mb-6 text-gray-900">Learn Your Way</h2>
            <p className="text-xl text-gray-600">Adaptive pathways, collaborative tools, and lifelong tracking that put the learner first.</p>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <AnimatedSection delay={0.2} className="flex-1 text-center lg:text-left order-1 lg:order-2">
              ...
              <h2 className="text-4xl font-bold mb-6 text-gray-900">Education That Never Gives Up</h2>
              <p className="text-xl text-gray-600 leading-relaxed">inspirelearning AI personalizes explanations, quizzes, and study schedules to match each learner's unique cognitive profile. Educators use our dashboard to track progress and collaborate on cross-cultural curricula.</p>
            </AnimatedSection>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-50/50">
        <div className="container mx-auto px-4 text-center">
          <AnimatedSection className="max-w-3xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 text-gray-900">Every Student Deserves a Great Tutor</h2>
            <p className="text-xl text-gray-600 mb-10">Join millions of learners and educators who are transforming education with AI.</p>
            <motion.a href="https://github.com/inspirelearningai" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
