            ...
            <div className="space-y-10">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <a href="mailto:hello@inspirelearningai.io" className="text-primary font-bold text-lg hover:underline">hello@inspirelearningai.io</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <a href="https://github.com/inspirelearningai" className="text-primary font-bold text-lg hover:underline">github.com/inspirelearningai</a>
                </div>
              </div>
